...
var fightOrSkip = function() {
  //ask a player if they would like to skip or fight using the fightOrSkip function
...
var shop = function() {
  ...
  var shopOptionPrompt = window.prompt('Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter 1 for REFILL, 2 for UPGRADE or 3 for LEAVE.');// use switch case to carry out action
